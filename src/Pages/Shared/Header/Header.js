                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="mx-auto">
                            <Nav.Link className='fs-5 text-white' as={Link} to="home">Home</Nav.Link>
                            <Nav.Link className='fs-5 text-white' as={Link} to="services">Services</Nav.Link>
                            <Nav.Link className='fs-5 text-white' as={Link} to="blog">Blog</Nav.Link>
